...
#Permite la carga del navegador
browser = webdriver.Edge("C:/Users/raul_/OneDrive/Escritorio/webscraping/MicrosoftWebDriver.exe")

# Permite conectarnos después a la API sin que nos de error.
url = browser.get('https://www.bet365.es/SportsBook.API/web?lid=3&zid=0&pd=%23AC%23B1%23C1%23D13%23E38119368%23F2%23&cid=171&ctid=171')
...
txt = open("C:/Users/raul_/OneDrive/Escritorio/webscraping/htmlEstatic.txt","w")
...
df.to_csv('output.csv',index=True)#xls
